package com.automati.config.security;
...
public class JWTUtils {
	...
	public String createJWT(String id, String issuer, long ttlMillis, Person person) {
		...
		logger.info("id " + id + " now " + now + " subject " + person.getEmail() + " issuer " + issuer);
		...
		builder.setId(id).setIssuedAt(now).setSubject(person.getEmail()).setIssuer(issuer);
